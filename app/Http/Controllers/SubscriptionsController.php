...
class SubscriptionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Log::info('Showing requests received : '.$request);
        if($validator->fails())
        {
            ...
            $subscription_end = Carbon::now()->addDays($request->input('days'));
            Log::info('Showing subscriptions: '.$subscriptions->device_id);


            // this is getting inserted into the database.
            $subscriptions->device_id = $request->input('device_id');
            $subscriptions->days = $request->input('days');
            $subscriptions->subscription_start = $subscription_start;
            $subscriptions->subscription_end = $subscription_end;
            $subscriptions->save();
